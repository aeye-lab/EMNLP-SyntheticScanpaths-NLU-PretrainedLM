...
def main():
	...
	for epoch in range(starting_epoch, args.num_train_epochs):
		...
		if new_score > old_score:
			...
			torch.save(model.state_dict(), '{}/State_glue_ours_lr{}_numsyn{}.pth'.format(args.output_dir, args.learning_rate, args.num_gen_synsp))
			old_score= new_score
	...
	#save results
	with open(f'{args.output_dir}/res_GLUE_ours_numsynsp{args.num_gen_synsp}.pickle', 'wb') as handle:
