...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='glue_results/', help="Where to store the final model.")
...
def main():
    ...
    train_dataloader = DataLoader(train_dataset, shuffle=True, collate_fn=default_data_collator, batch_size=args.per_device_train_batch_size, drop_last=True)
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        if new_score > old_score:
            ...
            torch.save(model.state_dict(), '{}/State_GLUE_finetune_BERTbase_lr{}.pth'.format(args.output_dir, args.learning_rate))
            old_score= new_score
    ...
    #save results
    with open(f'{args.output_dir}/GLUE_BERTbase_res_lr{args.learning_rate}.pickle', 'wb') as handle:
